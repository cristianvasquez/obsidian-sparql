...
export default class Prototype_11 extends Plugin {
    async onload() {
        ...
        debugApp.component("RdfTree", RdfTree);
    ...
    async syncWithTriplestore() {
      ...
      `;
        ...
        <div class="modal" style="padding: 20px; max-width: 80%; max-height: 80%; overflow: auto; background: var(--background-primary); border-radius: 8px;">
          <h3>Sync Output</h3>
          <pre style="background: var(--background-secondary); padding: 10px; border-radius: 4px; max-height: 400px; overflow-y: auto; white-space: pre-wrap;">${stdout}${
              stderr ? "\nSTDERR:\n" + stderr : ""
          }</pre>
